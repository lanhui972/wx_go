...
export default class Comm {
    ...
    ceBian() {	//左侧栏
        ...
        G.dom.cz_bgjs = new Dom('img', 'class:zche;zindex:15;src:' + I + 'zc/gray.png;x:0;y:0;width:100%;height:100%;', { click: function () { } });
        G.dom.cz_btn = new Btn('img', 'class:zche;zindex:15;src:' + I + 'zc/3.png;x:497;y:480;width:79;height:97;', { bli: 750, click: function () { that.moreX = 450; } });

        G.dom.cz_morebg = new Dom('img', 'class:zche;zindex:15;src:' + I + 'zc/2x.png;x:0;y:150;width:497;height:878;', { bli: 750 });
        G.dom.cz_gjList = new Dom('div', 'class:zche;zindex:15;line:0;border:#000;width:489;height:600;x:0;y:230;', { bli: 750});
    ...
    select(t) { //选择范围
        ...
        let that = this;
        G.delClass('comm');
        G.dom.bgdt = new Dom('img', 'class:comm;zindex:10;src:' + I + 'zc/gray.png;x:0;y:0;width:100%;height:100%;', { dclick: true });
    ...
    guoGuan(t) { //恭喜过关
        ...
        let that = this;
        G.dom.sdt = new Dom('img', 'class:comm;zindex:10;src:' + I + 'zc/gray.png;x:0;y:0;width:100%;height:100%;', { dclick: true });
        ...
        G.dom.sn_home = new Xg('img', 'class:comm;zindex:10;xg:1;src:' + I + 't_gb.png;x:578;y:173;width:88;height:87;', {
            click: function () {
        ...
        G.dom.next = new Xg('img', 'class:comm;zindex:10;xg:1;src:' + I + 'next.png;x:center;y:1000;width:139;height:32;', {
            click: function () {
                G.goPage('play', t.currGuan + 1);
                /*if (undefined === G.aaList || undefined === G.aaList.conf || undefined === G.aaList.conf.start || G.aaList.conf.start != 1) {
                    G.goPage('play', t.currGuan + 1);
    ...
    kdianGuo() {
        ...
        G.dom.next = new Xg('img', 'class:comm;zindex:10;xg:1;src:' + I + 'next.png;x:center;ry:310;width:139;height:32;', {
            click: function () {
                if (!G.zche.vad) { G.zche.vad = true; G.vad(6); G.goPage('play'); } else { G.goPage('play'); }
            }
